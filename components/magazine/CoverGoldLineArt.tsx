...
export function CoverGoldLineArt({ className = "" }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <rect x="18" y="18" width="364" height="524" stroke={`url(#${gold})`} strokeWidth="1.2" opacity="0.5" />
      <rect x="28" y="28" width="344" height="504" stroke={`url(#${gold})`} strokeWidth="0.6" opacity="0.35" strokeDasharray="4 3" />
      ...
      <circle cx="200" cy="200" r="72" stroke={`url(#${gold})`} strokeWidth="0.8" opacity="0.35" />
      <circle cx="200" cy="200" r="88" stroke={`url(#${gold})`} strokeWidth="0.4" opacity="0.25" strokeDasharray="2 4" />

      <g transform="translate(78, 118)" stroke={`url(#${gold})`} strokeWidth="1.35" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.75">
      ...
      <g transform="translate(198, 112)" stroke={`url(#${gold})`} strokeWidth="1.35" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.75">
      ...
      <g transform="translate(120, 380)" stroke={`url(#${gold})`} strokeWidth="1.1" fill="none" opacity="0.55">
      ...
      <path d="M40 40 h24 M40 40 v24" stroke={`url(#${gold})`} strokeWidth="1.2" opacity="0.55" />
      <path d="M360 40 h-24 M360 40 v24" stroke={`url(#${gold})`} strokeWidth="1.2" opacity="0.55" />
      <path d="M40 520 h24 M40 520 v-24" stroke={`url(#${gold})`} strokeWidth="1.2" opacity="0.55" />
      <path d="M360 520 h-24 M360 520 v-24" stroke={`url(#${gold})`} strokeWidth="1.2" opacity="0.55" />
